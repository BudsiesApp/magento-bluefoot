...
/**
 * Class Gene_BlueFoot_Model_Attribute_Backend_Image
 * @author Mark Wallman <mark@gene.co.uk>
 */
class Gene_BlueFoot_Model_Attribute_Backend_Image extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
