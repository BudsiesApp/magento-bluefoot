...
define(['bluefoot/config', 'bluefoot/jquery', 'bluefoot/hook', 'bluefoot/widget/abstract'], function (Config, jQuery, Hook, AbstractField) {
    ...
    InputField.prototype.buildHtml = function () {
        ...
        // Get the staticblock name for the placeholder text
        if( this.entity.data.hasOwnProperty("preview_view")
            && typeof this.entity.data["preview_view"][ this.field.code ] !== 'undefined'
            && typeof this.entity.data["preview_view"][ this.field.code ]["title"] !== 'undefined'
            && this.entity.data["preview_view"][ this.field.code ]["title"])
        {
            placeholder = this.entity.data["preview_view"][ this.field.code ]["title"];
        }

        if (this.entity.data[this.field.code + "_block_name"]) {
            placeholder = this.entity.data[this.field.code + "_block_name"];
        }
        ...
        this.element.append(
            ...
            jQuery('<input />').attr({
                name: this.field.code + "_block_name",
                type: this.getType(),
                id: fakeId
            }).val(placeholder),
